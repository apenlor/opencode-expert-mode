...
2. ~/.config/expert-mode/worktrees/<project-name>/ (global location)
...
### For Global Directory (~/.config/expert-mode/worktrees)
...
case $LOCATION in
  .worktrees|worktrees)
    ...
    ;;
  ~/.config/expert-mode/worktrees/*)
    path="~/.config/expert-mode/worktrees/$project/$BRANCH_NAME"
    ;;
esac
